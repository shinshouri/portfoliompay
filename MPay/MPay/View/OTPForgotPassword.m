...
@implementation OTPForgotPassword
{
...
@synthesize data, FlagValidateOTP, ECash, ParamInput;
...
- (void)UI {
    ...
    sendBtn = [self UIButton:self withFrame:CGRectMake(btnmarginleft, ([self view].frame.size.height/2)-btnheight, self.view.frame.size.width-(btnmarginleft*2), btnheight) withTitle:[@"send" uppercaseString]  withTag:0];
    [sendBtn setBackgroundColor:[self colorFromHexString:Color3 withAlpha:0.5]];
    [sendBtn setEnabled:NO];
    [bgview addSubview:sendBtn];
    
    UIButton *resendBtn = [self UIButton:self withFrame:CGRectMake(20, sendBtn.frame.size.height + sendBtn.frame.origin. y, self.view.frame.size.width - 40, 50) withTitle:[@"resendVerificationCode" uppercaseString]  withTag:1];
...
//        response = nil;
//        [self RequestData:self withAction:@"RequestOTP" withParams:[NSDictionary dictionaryWithObjectsAndKeys:DEVICETOKEN, @"deviceToken", @"N", @"haveECash", @"Y", @"resendFlag", @"forgotPassword", @"view", nil]];
...
//    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
//        response = nil;
//        [self RequestData:self withAction:@"ValidateOTP" withParams:[NSDictionary dictionaryWithObjectsAndKeys:DEVICETOKEN, @"deviceToken", [res text], @"otp", @"N", @"haveECash", @"", @"pin", @"forgotPassword", @"view", nil]];
...
//                [maskView removeFromSuperview];
//                [timer invalidate];
//                [self RequestAPIValidateCustomer];
//            }
//            else
//            {
//                [maskView removeFromSuperview];
...
//-(void)RequestAPIValidateCustomer {
//    [[self navigationController].view addSubview:[self showmask]];
//    [[self view] endEditing:YES];
//
//    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
//        response = nil;
//        [self RequestData:self withAction:@"ValidateCustomer" withParams:[NSDictionary dictionaryWithObjectsAndKeys: FlagValidateOTP, @"isValidateOTP", ParamInput, @"paramInput", nil]];
